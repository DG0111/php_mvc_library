...
<?php $__env->startSection('content'); ?>
    <div class="container">
        <form id="add-product-form" action="<?php echo e(BASE_URL . 'products/save-edit/'); ?>" method="post"
                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-8 offset-2">
                            <img id="preview-img" src="<?php echo e($pro->image); ?>" class="img-fluid">
                        </div>
                    </div>
                    <div class="form-group">
...
<?php echo $__env->make('layouts.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\baiTap1\app\views/product/editForm.blade.php ENDPATH**/ ?>