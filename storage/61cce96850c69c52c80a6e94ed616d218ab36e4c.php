<?php $__env->startSection('content'); ?>
    <form id="edit-car-form" action="<?php echo e(BASE_URL . 'car/save-edit-car'); ?>" method="post"
          enctype="multipart/form-data">
        <h3>Thêm mới car</h3>
        <div class="row">
            <div class="col-md-6">
                <input type="text" hidden name="id" value="<?php echo e($car->id); ?>">
                <div class="form-group">
                    <label>Name car<span class="text-danger">*</span></label>
                    <input type="text" value="<?php echo e($car->model_name); ?>" class="form-control" name="model_name">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input value="<?php echo e($car->price); ?>" type="text" class="form-control" name="price">
                </div>
                <div class="form-group">
                    <label>sale price<span class="text-danger">*</span></label>
                    <input value="<?php echo e($car->sale_price); ?>" type="text" class="form-control" name="sale_price">
                </div>
                <div class="form-group">
                    <label>Detail<span class="text-danger">*</span></label>
                    <input value="<?php echo e($car->detail); ?>" type="text" class="form-control" name="detail">
                </div>
                <div class="form-group">
                    <label>Quantity<span class="text-danger">*</span></label>
                    <input value="<?php echo e($car->quantity); ?>" type="text" class="form-control" name="quantity">
                </div>
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-8 offset-2">
                        <img id="preview-img" src="<?php echo e(BASE_URL . $car->image); ?>"
                             class="img-fluid">
                    </div>
                </div>
                <div class="form-group">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\baiTap2\app\views/admin/car/editForm.blade.php ENDPATH**/ ?>